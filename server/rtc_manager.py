...
class RTCManager:
    ...
    Manages the PeerConnection lifecycle, audio/video track send/receive, and DataChannel.
    """
    ...
    async def handle_offer(self, request):
        ...
        # Build via SessionManager (which internally checks max_session)
        try:
        ...
        # Create PeerConnection —— ICE servers are dynamically generated by Cloudflare (never expire)
